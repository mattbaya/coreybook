...
### COREY (as MATTRESS TESTER)
- **Physical**: Completely BALD head (no hair), peaceful sleeping expression
- **Clothing**: Comfortable pajamas or loungewear
- **Expression**: Blissfully asleep with "ZZZ"s floating above
- **Activity**: Professionally sleeping on luxurious mattress
- **Setting**: Scientific testing environment around the bed

### REMI (suggesting this career)
- **Physical**: Dark curly hair, brave/energetic personality
...
- **Expression**: Yawning as he suggests this sleepy career
- **Activity**: Speaking while looking tired, making the suggestion

### SCIENTISTS/RESEARCHERS
- **Activity**: Taking detailed notes on Corey's sleep performance
- **Equipment**: Clipboards, white lab coats, professional observation stance
- **Data**: Clipboard showing "COMFY: ✓✓✓✓✓" rating system
- **Sign**: "DO NOT DISTURB - TESTING IN PROGRESS"

### FAMILY OBSERVERS
- **EMILY**: Short silver/gray pixie-cut hair, watching with amused smile
- **OONA**: Long honey blonde hair, blue Super3 t-shirt, still bubbling with ideas
- **ZEPHYR**: Light brown messy hair, blue Super3 t-shirt, excited about more possibilities

### CAREER PREVIEW ELEMENTS (SWIRLING AROUND EDGES)
- **Visual Hints**: Water slides, golf balls, hot dogs, dogs doing yoga poses
- **Fortune Cookies**: Scattered around the edges
- **Mini Golf**: Windmills and obstacles
- **Text**: "TO BE CONTINUED..." indicating Book 4 approaching
...
**REMI** (dark curly hair, blue Super3 t-shirt) should be visible making the suggestion with a yawn, clearly inspired by his own sleepiness.
...
**Art Style**: Modern 2D cartoon style with cel-shading with dreamy, peaceful colors for the mattress testing scene (soft blues, comfortable whites) while the swirling career previews use bright, exciting colors that hint at the chaos to come in Book 4. The overall mood should be "sweet dreams... but MORE ADVENTURES AHEAD!"