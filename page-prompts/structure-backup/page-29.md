...
### COREY (TWO FANTASY SCENES)
- **Physical**: Completely BALD head (no hair) in both scenarios
- **Top Scene - Reverse Truck Driver**: Completely calm, looking over shoulder while driving enormous 18-wheeler in reverse
- **Bottom Scene - Journalist**: Hard-hitting reporter with "PRESS" badge in hat, notepad and pen
- **Expression**: Top: unnaturally calm, Bottom: serious investigative journalist
- **Activity**: Top: reverse driving, Bottom: asking tough questions

### REMI (passenger in truck)
- **Physical**: Dark curly hair, brave and energetic personality
...
- **Activity**: Giving thumbs up from truck passenger seat
- **Expression**: Confident in his dad's unconventional driving

### OTHER DRIVERS (top scene)
- **Activity**: Swerving to avoid the reverse truck, jaws dropped in amazement
- **Expression**: BAFFLED and TERRIFIED by Corey's reverse driving
- **Reactions**: Various states of confusion and panic

### TRAFFIC COP
- **Activity**: Scratching head in confusion at the reverse truck situation
- **Expression**: Completely puzzled by this traffic anomaly
- **Uniform**: Standard police traffic control outfit

### POLITICIAN (bottom scene)
- **Activity**: Being interviewed, sweating and loosening collar under pressure
- **Expression**: Nervous and uncomfortable under Corey's tough questioning
- **Appearance**: Typical nervous politician being held accountable
...
**Art Style**: Modern 2D cartoon style with cel-shading with bold, dynamic lines emphasizing movement in the truck scene and dramatic tension in the journalism scene. Use contrasting color palettes - highway blues/grays for the truck scene and newspaper blacks/whites/reds for the journalism scene.